...
class User(AbstractUser):
    ...
    class Meta:
        permissions = [
            ("can_edit_own_blog", "Can edit own blog"),
            ("can_delete_own_blog", "Can delete own blog"),
        ]
    def __str__(self):
        return self.email
...
#acess token -vfZkBWZxR21uRZYgg9yRgrpJWxw9
#refresh - xbRGUh5anacCiVh4jvS6odILfjZXhJAu